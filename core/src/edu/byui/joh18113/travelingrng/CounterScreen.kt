...
class CounterScreen(val game: Main) : Screen {
    ...
    private fun handleInput() {
        if (Gdx.input.justTouched()) {
            ...
            if (incrementBound1!!.contains(touchLocation!!.x, touchLocation!!.y)) {
                ...
                else if (touchLocation!!.x > (incrementBound1!!.x + widthInterval * 1.5) &&
                    touchLocation!!.x <= (incrementBound1!!.x + widthInterval * 4)) count1.add(5)
                else if (touchLocation!!.x > (incrementBound1!!.x + widthInterval * 4) &&
                    touchLocation!!.x <= (incrementBound1!!.x + widthInterval * 8)) count1.add(10)
                else if (touchLocation!!.x > (incrementBound1!!.x + widthInterval * 8) &&
                    touchLocation!!.x <= (incrementBound1!!.x + widthInterval * 12.5)) count1.add(20)
                else if (touchLocation!!.x > (incrementBound1!!.x + widthInterval * 12.5)) count1.add(50)
            }
            if (decrementBound1!!.contains(touchLocation!!.x, touchLocation!!.y)) {
                ...
                else if (touchLocation!!.x > (decrementBound1!!.x + widthInterval * 3.5) &&
                    touchLocation!!.x <= (decrementBound1!!.x + widthInterval * 8)) count1.sub(20)
                else if (touchLocation!!.x > (decrementBound1!!.x + widthInterval * 8) &&
                    touchLocation!!.x <= (decrementBound1!!.x + widthInterval * 12)) count1.sub(10)
                else if (touchLocation!!.x > (decrementBound1!!.x + widthInterval * 12) &&
                    touchLocation!!.x <= (decrementBound1!!.x + widthInterval * 14)) count1.sub(5)
                else if (touchLocation!!.x > (decrementBound1!!.x + widthInterval * 14)) count1.sub(1)
            }
            if (incrementBound2!!.contains(touchLocation!!.x, touchLocation!!.y)) {
                ...
                else if (touchLocation!!.x > (incrementBound2!!.x + widthInterval * 1.5) &&
                    touchLocation!!.x <= (incrementBound2!!.x + widthInterval * 4)) count2.add(5)
                else if (touchLocation!!.x > (incrementBound2!!.x + widthInterval * 4) &&
                    touchLocation!!.x <= (incrementBound2!!.x + widthInterval * 8)) count2.add(10)
                else if (touchLocation!!.x > (incrementBound2!!.x + widthInterval * 8) &&
                    touchLocation!!.x <= (incrementBound2!!.x + widthInterval * 12.5)) count2.add(20)
                else if (touchLocation!!.x > (incrementBound2!!.x + widthInterval * 12.5)) count2.add(50)
            }
            if (decrementBound2!!.contains(touchLocation!!.x, touchLocation!!.y)) {
                ...
                else if (touchLocation!!.x > (decrementBound2!!.x + widthInterval * 3.5) &&
                    touchLocation!!.x <= (decrementBound2!!.x + widthInterval * 8)) count2.sub(20)
                else if (touchLocation!!.x > (decrementBound2!!.x + widthInterval * 8) &&
                    touchLocation!!.x <= (decrementBound2!!.x + widthInterval * 12)) count2.sub(10)
                else if (touchLocation!!.x > (decrementBound2!!.x + widthInterval * 12) &&
                    touchLocation!!.x <= (decrementBound2!!.x + widthInterval * 14)) count2.sub(5)
                else if (touchLocation!!.x > (decrementBound2!!.x + widthInterval * 14)) count2.sub(1)
            }
        }
    ...
    override fun render(delta: Float) {
        ...
        fontWhite?.draw(game.sBatch, "First   ${count1.count}", counterBound1!!.x, counterBound1!!.y + counterBound1!!.height)
        fontGreen?.draw(
            game.sBatch, "1  5  10  20  50", incrementBound1!!.x, incrementBound1!!.y + incrementBound1!!.height
        )
        fontRed?.draw(
            game.sBatch, "50  20  10  5  1", decrementBound1!!.x, decrementBound1!!.y + decrementBound1!!.height
        )
        fontWhite?.draw(
            game.sBatch, "Second   ${count2.count}", counterBound2!!.x, counterBound2!!.y + counterBound2!!.height
        )
        fontGreen?.draw(
            game.sBatch, "1  5  10  20  50", incrementBound2!!.x, incrementBound2!!.y + incrementBound2!!.height
        )
        fontRed?.draw(
            game.sBatch, "50  20  10  5  1", decrementBound2!!.x, decrementBound2!!.y + decrementBound2!!.height
        )
        fontCyan?.draw(
